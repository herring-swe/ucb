...
#### P1
- [x] Memory: Memdbg quality improvements
...
- [x] `ucb/version.h` generated by CMake
- [x] Combined version define available
- [x] Separate version defines available (`MAJOR`, `MINOR`, `PATCH`)
- [x] Build/compiler/platform/backend capability defines available
- [x] Used as the authoritative capability query surface
- [x] Testing
- [x] Documentation
