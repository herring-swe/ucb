...
UCB_API ucb_pid_t ucb_thread_id(void);

/* ----------------- UCB_API ucb_thread_t* ucb_thread_new(); ---------------- */
UCB_API ucb_ecode ucb_thread_init(ucb_thread_t* thread);
UCB_API void ucb_thread_release(ucb_thread_t* thread);
UCB_API void ucb_thread_free(ucb_thread_t* thread);

UCB_API ucb_ecode ucb_thread_set_func(ucb_thread_t* thread, ucb_thread_func_t func, void* arg);
UCB_API ucb_ecode ucb_thread_set_exit_func(ucb_thread_t* thread, ucb_thread_exit_func_t func,
                                           void* arg);
UCB_API ucb_pid_t ucb_thread_get_id(ucb_thread_t* thread);

UCB_API ucb_ecode ucb_thread_start(ucb_thread_t* thread, ucb_thread_func_t func, void* arg);
UCB_API ucb_ecode ucb_thread_join(ucb_thread_t* thread);
